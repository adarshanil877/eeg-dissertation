...
for fold, (train_idx, test_idx) in enumerate(kfold.split(X,y), start=1):
    ...
    #PRINTING AUC FOLD RESULTS
    print("\nFOLD", fold, "RESULTS")
    print("LDA ACCURACY:", lda_accuracy, "AUC:", lda_auc)
    print("SVM ACCURACY:", svm_accuracy, "AUC:", svm_auc)
    print("RANDOM FOREST ACCURACY:", rf_accuracy, "AUC:", rf_auc)
    print("XGBOOST ACCURACY:", xgb_accuracy, "AUC:", xgb_auc)
    print("LOGISTIC ACCURACY:", log_accuracy, "AUC:", log_auc)
    print("DUMMY ACCURACY:", dummy_accuracy, "AUC:", dummy_auc)
    ...
    fold_auc_results.append([fold, lda_auc, svm_auc, rf_auc, xgb_auc, log_auc, dummy_auc])

#OVERALL AUC RESULTS FROM ALL FOLDS
print("\nFINAL AGGREGATE K-FOLD RESULTS")

lda_overall_auc = roc_auc_score(all_y_true, all_lda_prob)
svm_overall_auc = roc_auc_score(all_y_true, all_svm_prob)
rf_overall_auc = roc_auc_score(all_y_true, all_rf_prob)
xgb_overall_auc = roc_auc_score(all_y_true, all_xgb_prob)
log_overall_auc = roc_auc_score(all_y_true, all_log_prob)
dummy_overall_auc = roc_auc_score(all_y_true, all_dummy_prob)

print("LDA AUC : ", lda_overall_auc)
print("SVM AUC : ", svm_overall_auc)
print("RANDOM FOREST AUC : ", rf_overall_auc)
print("XGBOOST AUC : ", xgb_overall_auc)
print("LOGISTIC REGRESSION AUC : ", log_overall_auc)
print("DUMMY AUC : ", dummy_overall_auc)
